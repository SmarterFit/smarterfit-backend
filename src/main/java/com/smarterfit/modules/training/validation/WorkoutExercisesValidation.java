...
@Component
public class WorkoutExercisesValidation {

    private final WorkoutExercisesRepository workoutExercisesRepository;

    public WorkoutExercisesValidation(WorkoutExercisesRepository workoutExercisesRepository) {
        this.workoutExercisesRepository = workoutExercisesRepository;
    }

    public WorkoutExercises validateWorkoutExercisesById(UUID id) {
